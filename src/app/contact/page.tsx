  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <main className="max-w-4xl mx-auto px-4 py-16">
        <h1 className="text-4xl font-bold text-blue-600 mb-8">Contactez-nous</h1>
        
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="space-y-6">
            <div>
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">Nous sommes là pour vous aider</h2>
              <p className="text-gray-600 mb-4">
                Vous avez des questions sur nos services de comparaison de forfaits mobiles ? 
            ...
            <div className="border-t border-gray-200 pt-6">
              ...
              <a 
                href="mailto:infos@jointoffer.be"
